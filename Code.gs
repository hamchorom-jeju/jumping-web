...
// [이동 완료] 대시보드 통계 관련 함수들은 Admin.gs로 이관되었습니다.
// [이동 완료] 체크인/퇴실 및 조회 관련 함수들은 Admin.gs로 이관되었습니다.
// ──────────────────────────────────────────────
// 10. 신규 회원 가입 / 재등록 및 서명 API
// ──────────────────────────────────────────────

// [이동 완료] 회원 등록/리뉴얼(연장결제) 및 신규가입 관련 함수들은 각각 Admin.gs와 Registration.gs로 이관되었습니다.
// [이동 완료] 업무일지 및 매출 관련 함수들은 Admin.gs로 이관되었습니다.
// [이동 완료] 인바디 관리 관련 함수들은 Admin.gs로 이관되었습니다.
// [제거 완료] 33챌린지 랭킹 및 마감 관련 레거시 함수들(getChallengeRanking, setCheck, setAllChecks)은 삭제되었습니다.
// [이동 완료] 테라피 예약 및 공휴일/벙개 설정 관련 함수들은 Admin.gs로 이관되었습니다.
// [이동 완료] 문자관리 및 예약 티켓 검사 관련 함수들은 Admin.gs로 이관되었습니다.
// 33 챌린지 게임 시스템 - 기초 셋업
// ──────────────────────────────────────────────
 ...
 */
// [제거 완료] setup33ChallengeSheets 레거시 함수는 삭제되었습니다.
/**
...
// [이동 완료] getWisdomTips 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] saveWisdomTip 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] updateWisdomTip 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] getRecentCertifications 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] blessAction 함수는 Sanctum.gs 로 이관되었습니다.
...
// [이동 완료] createSurpriseQuest 함수는 Sanctum.gs 로 이관되었습니다.
...
// ==========================================
// [이동 완료] checkAndCreateQuestRegistrySheet 함수는 Sanctum.gs 로 이관되었습니다.


// [perf] ss 객체, logData, memberName을 외부에서 공유받아 SpreadsheetApp 및 시트 읽기 중복 방지

// [이동 완료] getActiveQuestStatus 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] triggerGlycogenQuest 함수는 Sanctum.gs 로 이관되었습니다.
 ...
 * ==========================================
 */
// [이동 완료] checkAndInitNoticeSheet 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] getPillarNotice 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] updatePillarNotice 함수는 Sanctum.gs 로 이관되었습니다.


// [이동 완료] getDailyActiveAdventurers duplicate 함수는 Bridge_Login.gs로 단일화되어 이동되었습니다.
// [이동 완료] getDailyAwardedExperience 함수는 Sanctum.gs 로 이관되었습니다.
...
// [이동 완료] checkAndAwardWeeklyAttendanceBonus 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] sendWeeklyBonusNotification 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] sendWeeklyBonusSms 함수는 Sanctum.gs 로 이관되었습니다.


// [v65.00] 구글의 소스코드 노출 자동차단을 예방하는 안전한 백엔드 API 키 저장/배포 시스템 (복수 키 로테이션 풀 지원)
// [이동 완료] getGeminiApiKey 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] getPollinationsApiKey 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] appendPollinationsApiKey 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] cleanPollinationsApiKey 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] getOrCreateWisdomFolder 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] saveBase64ImageToDrive 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] migrateSingleImage 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] setGeminiApiKey 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] callGeminiBackendWithDetails 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] callGeminiBackend 함수는 Sanctum.gs 로 이관되었습니다.
 ...
 * ==========================================
 */
// [이동 완료] getJejuRealtimeWeather 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] getVillageSettings 함수는 Sanctum.gs 로 이관되었습니다.


// [이동 완료] resolveSunoUrl 및 resolveSingleSunoUrl 함수는 Bridge_Login.gs로 이동되었습니다.
// [이동 완료] updateVillageSettings 함수는 Sanctum.gs 로 이관되었습니다.
...
// [이동 완료] getWisdomTipsWithReactions 함수는 Sanctum.gs 로 이관되었습니다.
...
// [이동 완료] getVillageNotices 함수는 Sanctum.gs 로 이관되었습니다.
...
// [이동 완료] SeededRandom 함수는 Sanctum.gs 로 이관되었습니다.

// [이동 완료] getAlgorithmicSuddenQuest 함수는 Sanctum.gs 로 이관되었습니다.
